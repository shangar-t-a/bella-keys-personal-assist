...
class AssetResponseMapper:
    ...
    def to_response_model(asset: AssetWithCalc) -> AssetResponse:
        ...
        return AssetResponse(
            ...
            base_asset_value=asset.base_asset_value,
            additional_spent=asset.additional_spent,
            total_loan_interest=asset.total_loan_interest,
            total_cash_outflow=asset.total_cash_outflow,
