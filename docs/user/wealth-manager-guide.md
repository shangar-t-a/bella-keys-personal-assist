...
Your net worth is the sum of all your asset current values minus the sum of all your outstanding liability balances:

$$\text{Net Worth} = \sum \text{Asset Current Values} - \sum \text{Liability Outstanding Balances}$$

A positive net worth means your assets are worth more than your debts. The dashboard shows this at a glance along with a breakdown by category.
